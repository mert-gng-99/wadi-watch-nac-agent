...
For Wadi Watch: at enrolment, from lists cities, site owners and co-operatives already keep, from the enrolled resident or worker, who owns the line and agrees once. Checks run only while an alert is open for a zone that person is enrolled in. There is no monitoring between alerts.
